...
# ==========================================
# 2. LIFESPAN: LAZY-LOAD SBERT STANDAR
# ==========================================
ml_models = {}
...
async def lifespan(app: FastAPI):
    ...
    # Load standar tanpa ONNX (jauh lebih stabil di Railway)
    ml_models["sbert"] = SentenceTransformer('paraphrase-multilingual-MiniLM-L12-v2')
